...
router.post('/', (req, res) => { //create new recipe
    /*{ //req.body should look like this...
        ingredient: "1 cup of flour, 1/4 tsp of vanilla",
        direction: "Mix the sugar and butter using dough",
        photo_path: "images/stuff",
        rating_id: [1, 2, 3, 4]
      }*/
